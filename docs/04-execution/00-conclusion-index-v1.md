...
- Alpha bounded proof 已通过，下一步唯一允许推进的是 Signal freeze review。
- Alpha full build、Signal construction、Position / Portfolio Plan / Trade / System 施工和全链路
  pipeline 仍未放行，直到后续门禁通过并明确授权。
