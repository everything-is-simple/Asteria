...
`portfolio-plan-2024-coverage-repair-card-20260509-01` 现已通过，当前 live `current_allowed_next_card`
已切到 `trade_2024_coverage_repair_card`。
...
- 当前唯一 live next card 只允许 Trade 2024 released day surface repair，不得扩成 System / Pipeline repair
...
| 优先级 | 候选卡 | 说明 |
|---|---|---|
| P0 | `trade-2024-coverage-repair-card-20260509-01` | Portfolio Plan repair 已真实收口后，下一个唯一 live next card |
...
| 层级 | 作用 | 当前内容 |
|---|---|---|
| 层 1 | 当前 live next card | `trade-2024-coverage-repair-card-20260509-01` |
...
| 顺序 | 候选卡 | 目标 |
|---:|---|---|
| 1 | `trade-2024-coverage-repair-card-20260509-01` | Portfolio Plan repair 已通过；当前需在 Trade 边界内继续收口 released day surface，再决定是否继续下移到 System repair |
...
- 当前 live `current_allowed_next_card` 是 `trade_2024_coverage_repair_card`；Pipeline 已通过
  ...
  `trade-2024-coverage-repair-card-20260509-01`。下一步只允许继续 Trade 2024 released day
