...
`alpha-signal-2024-coverage-repair-card-20260509-01` 与
`position-2024-coverage-repair-card-20260509-01` 现已通过，当前 live `current_allowed_next_card`
已切到 `portfolio_plan_2024_coverage_repair_card`。
...
- 当前唯一 live next card 只允许 Portfolio Plan 2024 released day surface repair，不得扩成 Trade / System / Pipeline repair
...
| 优先级 | 候选卡 | 说明 |
|---|---|---|
| P0 | `portfolio-plan-2024-coverage-repair-card-20260509-01` | Position repair 已真实收口后，下一个唯一 live next card |
| P1 | `trade-2024-coverage-repair-card-20260509-01` | 仅在 Portfolio Plan 2024 repair 后仍证明首断点位于 Trade 时才可进入 live authority |
...
| 层级 | 作用 | 当前内容 |
|---|---|---|
| 层 1 | 当前 live next card | `portfolio-plan-2024-coverage-repair-card-20260509-01` |
| 层 2 | 近程 backlog candidates | `trade-2024-coverage-repair-card-20260509-01`，`pipeline-one-year-strategy-behavior-replay-rerun-build-card-20260509-01` |
...
| 顺序 | 候选卡 | 目标 |
|---:|---|---|
| 1 | `portfolio-plan-2024-coverage-repair-card-20260509-01` | Position repair 已通过；当前需在 Portfolio Plan 边界内继续收口 released day surface，再决定是否继续下移到 Trade repair |
...
- 当前 live `current_allowed_next_card` 是 `portfolio_plan_2024_coverage_repair_card`；Pipeline 已通过
  ...
  `portfolio-plan-2024-coverage-repair-card-20260509-01`。下一步只允许继续 Portfolio Plan 2024 released day
  surface repair；这仍不是 System full build、full rebuild、daily incremental 或 `v1 complete` 授权。
