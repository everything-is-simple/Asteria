...
暂停 Position bounded proof 施工，并已拆出七张上游修补卡。当前只允许先执行
`data-reference-target-maintenance-scope-20260506-01`；仍不得扩展为 Position full build、
...
|---:|---|---|---|---|
| 1 | `data-reference-target-maintenance-scope-20260506-01` | Data | prepared / not executed | 冻结 reference gaps 必补范围 |
| 2 | `data-reference-target-maintenance-closeout-20260506-01` | Data | prepared / not executed | 按范围卡补 Data reference facts 与审计 |
...
这些 prepared cards 不等于 passed conclusions；未执行前不登记为完成结论，不创建任何正式 Position/downstream/Pipeline 产物。
...
| 1 | MALF | 六件套已交付 / v1.4 day runtime sync 已通过 / v1.4 authority sync 已通过 | frozen | 否 | `docs/02-modules/malf/` | day runtime proof 已升级到 v1.4；week/month 未执行 |
...
| Position | `docs/02-modules/position/00-authority-design-v1.md` | freeze review passed / design contract frozen / build not executed |
| Position | `docs/02-modules/position/01-semantic-contract-v1.md` | freeze review passed / design contract frozen / build not executed |
| Position | `docs/02-modules/position/02-database-schema-spec-v1.md` | freeze review passed / design contract frozen / build not executed |
| Position | `docs/02-modules/position/03-runner-contract-v1.md` | freeze review passed / design contract frozen / build not executed |
| Position | `docs/02-modules/position/04-audit-spec-v1.md` | freeze review passed / design contract frozen / build not executed |
| Position | `docs/02-modules/position/05-build-card-v1.md` | freeze review passed / bounded-proof card specification frozen / build not executed |
...
review-only 审查并通过。MALF complete alignment closeout 已通过。当前下一步唯一允许动作已改为
data reference target maintenance scope；Signal full build、Position full build、
...
MALF complete alignment closeout 已补齐 dense evidence。当前下一卡推进到
Position bounded proof build card，不得扩展为 Signal full build、Position full build
或下游施工。
...
已完成 review-only 审查并通过，MALF complete alignment closeout 已通过，下一步只允许
...
在 Position bounded proof build card 未明确执行并通过 release gate 前，不允许：
