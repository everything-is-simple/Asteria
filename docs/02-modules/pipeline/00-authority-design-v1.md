...
当前 live `current_allowed_next_card` 是 `trade_2024_coverage_repair_card`。
...
存在，因此当前唯一 live repair 施工位已经收口到 Trade，不允许直接跳去 System Readout repair、
