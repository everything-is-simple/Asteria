...
`position-2024-coverage-repair-card-20260509-01`。Pipeline 当前只保留 blocked replay truth、
Alpha/Signal repair passed truth 与 downstream closeout passed truth，不再拥有新的 live repair 施工位；
后续如需继续推进 Portfolio Plan repair、Trade repair、System Readout repair、Pipeline source-selection repair、
full rebuild、daily incremental 或 `v1 complete`，都必须等 Position 2024 coverage repair 形成结论后再单独授权。
