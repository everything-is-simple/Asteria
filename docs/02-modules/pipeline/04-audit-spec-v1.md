...
| `year_replay / year_replay_rerun` 未覆盖完整自然年却被登记成 passed | hard fail |
| `year_replay_rerun` 未锁到 `malf-2024-natural-year-coverage-repair-card-20260509-01-batch-0001` 却被登记成 passed | hard fail |
...
rerun 也已真实执行，但证明 released Alpha / Signal observation chain 仍未跟上 repaired MALF source。
