...
截至 `portfolio-plan-2024-coverage-repair-card-20260509-01` completed：
...
| 当前已准备执行卡 | `trade_2024_coverage_repair_card` |
| 当前只允许施工 | Trade 2024 released day surface repair |
...
`2024-01-05` 存在，语义断点已继续下移到 Trade。当前 live authority 已切到
`trade_2024_coverage_repair_card`。当前只允许 Trade 2024 released day surface repair，不允许扩成
System / Pipeline semantic repair，或打开 full rebuild / v1 complete。
