...
`pipeline-single-module-orchestration-build-card-20260508-01` 也已闭环。Pipeline 当前已执行最小
`system_readout` 单模块 runtime，但 full-chain 仍未授权。
