...
| `market_meta.duckdb` | Data market meta formalization passed / SW industry snapshot partially released | `docs/04-execution/records/data/data-market-meta-sw-industry-snapshot-20260502-01.evidence-index.md` |
...
| `market_meta.duckdb` | 已按可证事实优先口径最小正式化；申万 2021 当前行业快照部分释放；其他 reference gaps retained |
