...
| `market_meta.duckdb` | Data market meta formalization passed | `docs/04-execution/records/data/data-market-meta-formalization-20260502-01.evidence-index.md` |
...
| `market_meta.duckdb` | 已按可证事实优先口径最小正式化；reference gaps retained |
