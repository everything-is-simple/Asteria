...
from asteria.alpha.bootstrap import ALPHA_FAMILY_DATABASES, run_alpha_family_build
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run one Alpha family bounded proof build.")
    ...
    parser.add_argument("--mode", choices=sorted(VALID_ALPHA_RUN_MODES), required=True)
