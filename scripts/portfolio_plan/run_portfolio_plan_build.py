...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Portfolio Plan build.")
    _add_common_args(parser)
    args = parser.parse_args()
    summary = run_portfolio_plan_build(_request_from_args(args))
...
def _add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--mode", choices=["audit-only", "bounded", "resume"], default="bounded")
...
def _request_from_args(args: argparse.Namespace) -> PortfolioPlanBuildRequest:
