...
from asteria.malf.bootstrap import run_malf_day_lifespan_build
from asteria.malf.contracts import MALF_SCHEMA_VERSION, VALID_TIMEFRAMES, MalfDayRequest


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run Asteria MALF day lifespan bounded-proof scaffold."
    )
    ...
    summary = run_malf_day_lifespan_build(
        MalfDayRequest(
            ...
            lifespan_db=Path(args.target_db),
            service_db=Path("NUL"),
