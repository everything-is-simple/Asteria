...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Position build.")
    _add_common_args(parser)
    args = parser.parse_args()
    summary = run_position_build(_request_from_args(args))
...
def _request_from_args(args: argparse.Namespace) -> PositionBuildRequest:
