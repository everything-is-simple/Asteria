...
from asteria.system_readout.bootstrap import run_system_readout_bounded_proof


def main() -> int:
    parser = argparse.ArgumentParser(description="Run System Readout bounded proof.")
    parser.add_argument(
