...
from asteria.portfolio_plan.coverage_repair_shared import (
    build_earliest_day_map,
    portfolio_plan_report_dir,
    summary_status,
    utc_now,
)
...
def write_repair_evidence(
    *,
    ...
    report_dir = portfolio_plan_report_dir(request.report_root, request.run_id)
    ...
    manifest = {
        ...
        "stage": "portfolio_plan_2024_coverage_repair",
        ...
        "input_position_count": audit_payload["input_position_count"],
        "admission_count": audit_payload["admission_count"],
        "target_exposure_count": audit_payload["target_exposure_count"],
        "trim_count": audit_payload["trim_count"],
        "followup_next_card": followup_next_card,
        "followup_attribution": followup_attribution,
    ...
    with zipfile.ZipFile(validated_zip, "w", zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.write(audit_report_path, arcname="portfolio-plan-day-audit-summary.json")
