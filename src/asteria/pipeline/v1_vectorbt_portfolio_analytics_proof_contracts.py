...
V1_VECTORBT_PORTFOLIO_ANALYTICS_PROOF_RUN_ID = (
...
V1_BROKER_ADAPTER_FEASIBILITY_CARD = "v1-broker-adapter-feasibility-card"
...
class VectorbtPortfolioAnalyticsProofRequest:
    repo_root: Path
    ...
    run_id: str = V1_VECTORBT_PORTFOLIO_ANALYTICS_PROOF_RUN_ID
...
@dataclass(frozen=True)
class VectorbtPortfolioAnalyticsProofSummary:
    run_id: str
    status: str
    live_next_card: str
    ...
    completed_portfolio_matrix: bool
